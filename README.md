...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/timmy
```

A live public deployment of this template is available at [https://timmy.templates.workers.dev](https://timmy.templates.workers.dev)
